...
DEFAULT_PLUGINS="cloudbees-folder gradle ant git antisamy-markup-formatter build-timeout credentials-binding timestamper github-branch-source pipeline-github-lib pipeline-stage-view pam-auth ldap email-ext mailer matrix-auth ssh-slaves ws-cleanup"
